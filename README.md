...
| `watchlist_get` / `watchlist_add` / `watchlist_remove` | Read/modify watchlist |
...
- **Transport**: MCP over stdio (79 tools) + CLI (`tv` command, 30 commands with 67 subcommands)
